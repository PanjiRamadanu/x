...
wait = {
    ...
    "unsend":False,
    "mention":"Show Status Member Sider",
...
#KICKALL
                        elif "kickallmembers" in msg.text:
                          if msg._from in admin:
                           if msg.toType == 2:
                              print("ok")
                              _name = msg.text.replace("!kickallmembers","")
