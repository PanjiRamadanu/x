...
#cl = LineClient()
cl = LineClient(authToken='EIspzgIHH3QP7ypp3j75.D5EA5YJAo6RETGYB4MzKTq.0Df7asx950BscXV3j19QWKyeQEG/XMEU2c9GxKe+9bY=')
...
poll = LinePoll(cl)
call = cl
creator = ["u77979ae728da3baadeb60c9be26664b5"]
owner = ["u77979ae728da3baadeb60c9be26664b5"]
admin = ["u77979ae728da3baadeb60c9be26664b5"]
staff = ["u77979ae728da3baadeb60c9be26664b5"]
        ...
        for i in mid:
            ...
            if no < len(mid):
                ...
                try:
                    ...
                    no = "\n╚══[ Success ]"
        cl.sendMessage(to, textz, {'MENTION': str('{"MENTIONEES":' + json.dumps(arr) + '}')}, 0)
    except Exception as error:
        cl.sendMessage(to, "[ INFO ] Error :\n" + str(error))
